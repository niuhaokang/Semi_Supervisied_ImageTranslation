...
from networks.lightweight_gan.diff_augment import DiffAugment
from networks.lightweight_gan.version import __version__
...
class Discriminator(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.decoder2 = SimpleDecoder(chan_in = features[-2][-1], chan_out = init_channel) if resolution >= 8 else None
...
if __name__ == '__main__':
    ...
    model = Discriminator(image_size=256).to(device)
